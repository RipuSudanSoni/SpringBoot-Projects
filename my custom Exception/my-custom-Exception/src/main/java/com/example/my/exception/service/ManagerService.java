...
import com.example.my.exception.customException.ResourceNotFoundException;
...
public class ManagerService {
	...
	Manager resManager = managerList.stream().filter((manager) -> manager.getManagerId() == managerId).findFirst()
